...
<html>
    ...
    <title> HTML Encoder - p3ntestert00ls </title>
...
<center>
        ...
        <div class="submit">
          <input style="background-color: #05ff12" id="execute" type="button" value="Encode" class="btn">
          <label>
        ...
        <br>
            <div>
                 <a href="/p3ntestert00ls/tool/html-decoder.php">
    ...
    <script src="https://unpkg.com/typewriter-effect@latest/dist/core.js"></script>
     ...
     <script src="https://cdn.jsdelivr.net/gh/emn178/js-htmlencode/build/htmlencode.min.js"></script>
      <script>method = htmlEncode;</script>
    </div>
