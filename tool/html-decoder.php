...
<html>
    ...
    <title> HTML Decoder - p3ntestert00ls </title>
...
<center>
        ...
        <div class="submit">
          <input style="background-color: #05ff12" id="execute" type="button" value="Decode" class="btn">
          <label>
        ...
        <br>
            <div>
                ...
                <button  class="decoder" class="btn btn-default">Encoder</button>
                </a>
            </div> 
      </div>
</center>
    ...
    <script src="https://unpkg.com/typewriter-effect@latest/dist/core.js"></script>
     ...
     <script src="https://cdn.jsdelivr.net/gh/emn178/js-htmlencode/build/htmlencode.min.js"></script>
      <script>method = htmlDecode;</script>
    </div>
