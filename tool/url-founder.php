...
<html>
    ...
    <title> Subdomain Finder - p3ntestert00ls </title>
...
<form action="" method="_GET">
  <input style="color: black; text-align: center;" type="text" name="target" placeholder="Enter URL"><br><br>
<!--   <input style="background-color: " type="submit" value=""> -->
  ...
  <div class="div" style="background-color: : yellow">
    ...
    <?php
          ...
          $api = "https://archive.org/wayback/available?url="; //thanks to n45ht
          $target = $_GET['target'];
          echo "\n";
          $satu = $api.$target;
          ...
          echo "\n<br><p style='color:Red'><b>Total Subdomains: $tot</b></p>\n";
          foreach($get['url'] as $sub){ echo "<p>".$sub."</p>";}
    ?>
    </div>
