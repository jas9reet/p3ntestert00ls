...
<html>
    ...
    <title> Base64 Decoder - p3ntestert00ls </title>
...
<center>
        ...
        <div class="submit">
          <input style="background-color: #05ff12" id="execute" type="button" value="Decode" class="btn btn-default">
          <label>
    ...
    <script>method = base64.decode;</script>
